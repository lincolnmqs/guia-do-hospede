...
function TypingIndicator() {
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#54B3D4] to-[#0E7DA6] text-white"
      >
        <Sparkles size={13} />
      </span>
      <div className="flex items-center gap-1 rounded-2xl rounded-tl-sm border border-[#E2EAF0] bg-white px-4 py-3 shadow-[0_2px_8px_0_rgb(14_125_166_/_0.06)]">
        {[0, 1, 2].map((i) => (
          <span
            key={i}
            aria-hidden="true"
            className="inline-block h-1.5 w-1.5 rounded-full bg-[#54B3D4]"
            style={{
      ...
      <div className="flex flex-col items-center gap-3">
        <span
          ...
          className={cn(
            ...
            "bg-gradient-to-br from-[#54B3D4] to-[#0E7DA6] shadow-[0_4px_16px_0_rgb(14_125_166_/_0.25)]",
          )}
        >
      ...
      >
        {SUGGESTED_QUESTIONS.map((q) => (
          <button
            ...
            className={cn(
              "rounded-full border border-[#C7E8F4] bg-[#EBF6FA] px-4 py-2",
              "text-sm font-[family-name:var(--font-body)] text-[#0E7DA6]",
              "transition-all duration-150 hover:bg-[#54B3D4] hover:border-[#54B3D4] hover:text-white",
  ...
  return (
    <section
      ...
      className={cn(
        ...
        "shadow-[0_2px_12px_0_rgb(14_125_166_/_0.07)]",
        "overflow-hidden",
      )}
    >
      {/* Header */}
      <div
        className={cn(
          ...
          "bg-gradient-to-r from-[#EBF6FA] to-white",
        )}
      >
        <span
          aria-hidden="true"
          className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-[#54B3D4] to-[#0E7DA6]"
        >
        ...
        {isStreaming && (
          <span
            aria-hidden="true"
            className="ml-auto flex items-center gap-1.5 text-xs font-[family-name:var(--font-body)] text-[#0E7DA6]"
          >
            <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-[#54B3D4]" />
            Respondendo...
          </span>
        )}
      </div>
